...
DioApiClient apiClient =DioApiClient();
  ...
  void someFunction() async {
    ...
    final apiResponse = await apiClient.requestWithOutAuth<TeamScreenModelClass>(
      path: 'team_list',
      ...
      fromJson: (json) => TeamScreenModelClass.fromJson(json), // Function to parse the JSON response
    );
    if (apiResponse.result) {
      TeamScreenModelClass data = apiResponse.data!;

      AlertHelper.showAppSnackBar(context, message: data.teamScreenModelClassData.first.name);
